...
def v1_main():
    ...
    print(f"master_orchestrator_and_proxy_start返回的orchestrator所在内存为：{id(orchestration_module)}")
...
def main():
    ...
    booster_deploy_daemons_thr = threading.Thread(target=booster_deploy_daemons, args=(deploy_queue, scheduler))
